            ...
            <div className="p-4">
              ...
              <Table>
                <tbody>
                  ...
                  <tr className="text-end" style={{background: 'lightgrey'}}>
                    <td></td>
                    <td className="fw-bold" style={{width: '100px',color: "darkred",fontWeight: "800"}}>TOTAL</td>
                    <td className="text-end" style={{width: '100px',color: "darkred",fontWeight: "800"}}>{this.props.currency} {this.props.total}</td>
                  </tr>
                </tbody>
              </Table>
